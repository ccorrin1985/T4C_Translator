...
In the T4C Client options, ensure that the log is activated and that all log options are enabled, including NPC interaction and that the main log option is enabled.
